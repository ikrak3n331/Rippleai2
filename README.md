...
| `/pages/login.html` | Log in | Standalone entry point — no banner or footer. Brand wedge, centred 434px card. |
...
4. **`Email Notification` was removed.** It was built as a fixed 1040px email template
   rather than a responsive page, and has since been dropped from the project.
...
src/components.css hero, cards, form controls, tabs, login, gallery
